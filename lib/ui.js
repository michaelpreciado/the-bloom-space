...
/**
 * Header goes solid once the hero has passed. Pages with no hero start
 * solid, since there is nothing dark behind the bar.
 */
export function initHeaderState() {
  ...
  const headerH = getComputedStyle(document.documentElement)
    .getPropertyValue('--header-h').trim() || '88px';
